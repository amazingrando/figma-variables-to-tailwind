...
// }`;
  ...
  return (
    <Container space='medium' className='mesh h-screen p-3 root'>
      <div className='bg-white rounded-lg p-4'>
        <Text className='text-xl text-balance m-0 font-sans font-bold text-slate-800'>Export Color Variables for Tailwind</Text>
