...
// }`;
  ...
  return (
    <Container space='medium' className='h-screen p-6 root bg-dark text-white bg-left-bottom bg-no-repeat	bg-50%' style={{ backgroundImage: `url(${bg})` }}>
            ...
            {colors && (
              <div>
                ...
                <div className="relative">
                  ...
                  <pre className="overflow-auto max-h-[270px] p-2 pt-6 bg-pre text-dark rounded">
        ...
        <Text className='text-xs text-balance flex flex-row justify-end items-center gap-1 absolute bottom-4 right-4 w-[200px]'>
          ...
          <a href="https://github.com/amazingrando/figma-variables-to-tailwind" target="_blank" className="underline inline-flex items-center gap-1">Github</a> 
        </Text>
        {showToast && (
